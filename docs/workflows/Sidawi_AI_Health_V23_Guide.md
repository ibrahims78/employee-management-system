...
**ما يُرسله:**
```json
{ "phoneNumber": "966501234567", "activationCode": "ABCD1234" }
```
...
```
النوع:    @n8n/n8n-nodes-langchain.toolHttpRequest
الرابط:   /api/v1/bot/generate-excel-link
الغاية:   تصدير كامل قاعدة بيانات الموظفين كملف Excel
```
...
#### النوع 3: تقرير التنظيف الساعي — Admin_Cleanup_Report (العقدة 36)
...
تمت إضافة 3 endpoints جديدة لدعم الورك فلو:
